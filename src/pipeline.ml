  ...
  let docker_services =
    ...
    Current.all @@ List.map build [
      ...
      ocurrent, "ocaml-multicore-ci", [
        docker "Dockerfile"     ["live", "ocurrent/multicore-ci:live", [`Ci4, "infra-multicore-ci-web"]];
        docker "Dockerfile.web" ["live-web", "ocurrent/multicore-ci-web:live", [`Ci4, "infra-multicore-ci-web"]];
      ];
    ]
